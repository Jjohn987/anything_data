---
title: "Project3"
description: "Creating a dashboard with Shiny dashboard and Milwaukee Beer data that I obtained. Track sentiment, and discover & compare beers that are brewed in Milwaukee!"
...
* Plannning a visit? Toggle dropdown to get the top 10 rated beers by a brewery.
* Observe "sentiment" expressed in reviews to see if its a brewery you want to avoid. (Disclaimer: There is limited comment data, but the concept is important)
...
* Obtained by webscraping Milwaukee section of beeradvocate.org
