...
I suddenly got bit by a bug to learn about network analysis. So I recalled the [Correlates of War Project](http://www.correlatesofwar.org/data-sets/formal-alliances) having a dataset about alliances. I decided to revisit them and download the data for this new project, which you can do to.
