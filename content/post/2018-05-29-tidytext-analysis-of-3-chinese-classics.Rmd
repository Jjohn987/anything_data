...
In my next post, I would like to either **follow the same procedure but with bigrams**, and/or **apply LDA (Latent Dirichlet Allocation)** to these 3 works and see whether or not their chapters can be distinguished from one another. The word frequencies feel quite characteristic for these texts. 

But I'm not so sure that all of these chapters can be distinguished from one another (there are many shared words - Dao isn't solely mentioned in Taoist texts, the Analects also makes many mentions of civic related concepts, and the Mozi is a long text written by different authors...) 
