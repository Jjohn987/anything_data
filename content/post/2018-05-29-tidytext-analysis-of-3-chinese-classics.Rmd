...
In following similar pace with Tidytext, I first download my data. Here I use my package ```ctextclassics```, but I want to point out the API limit is very low and I had to download my books between two different days. So therefore in this post, I source my data in from a file of my text data.
