...
We can see that the Analects has prevalant usage of words such as "Benevolence" (仁), "Gentleman" (君子) and "Confucius" (孔子). (I capitalize these terms to show they are uniquely different from contemporary English equivalents.) In fact, the Analects often mentions these terms - one examplary sentence may be:
