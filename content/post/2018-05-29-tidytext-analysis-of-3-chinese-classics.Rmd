...
These word frequencies are very pleasing! From the graph, we can see that the Analects has prevalant usage of words such as "Benevolence" (仁), "Gentleman" (君子) and "Confucius" (孔子). I say pleasing, because in fact, benevolence is one of the core ideals of Confucianism. An examplary sentence can be found in the Analecs may be
...
The Zhuangzi, a Taoist text, mentions cosmological concepts such as the Tao(道) and morality (德).

And this is a convenient end to conclude this post on. In this post, I...
