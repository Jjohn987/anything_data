...
<center> <img src = "/1_distributions.png" width = 550 height = 550></center>
...
<center> <img src = "/2_distributions.png" width = 600 height = 600></center>
...
<center> <img src = "/3_categorical_distributions.png" width = 600 height = 500></center>
...
<center><div class = ""; display: inline-block> <img src = "/pairs1.png" width = 300, height = 300>
<img src = "/pairs2.png" width = 300 height = 300></div></center>
...
<center><img src = "/churnclassplot.jpeg" width = 500 height = 400></center>
...
**Now lets try to build some models to help predict churn** I'll use two versions of predictor sets to fit models, one with the regular set of variables, and another with an "expanded set" where categorical variables are coded into binary (1-0) values. If you wish to see code, feel free to check github.
...
<center><img src = "/sensitivity.png" width = 600 height = 600></center>
...
<center><img src = "/roc_curve.png" width = 600 height = 600></center>
...
<center><img src = "/performance.png" width = 600 height = 600></center>
## Conclusion 

In closing, the best models are the C50 and random forest models built on the expanded set of predictors. Since we are interested in churn, we can improve the performance of our predictions by altering our threshold cutoffs. But I'll refrain from this and stick with the original model fit, since we do not have an extra test set of data to test the new cutoff on.  All in all, predicting churn was an informative exercise!