...
# Motivation #
<font size = 4>
It's been a dream of mine to break into the data science field, so prior to my move, I decided to add another project to my portfolio -- a sleek Shiny dashboard. Along the way I also discovered `highcharter`, an amazing library for interactive plots. (If you haven't heard of it, look it up!) First, let me provide an example of a highcharter plot I used in my dashboard. I hope it will invoke your curiosity and ultimately lure you to my app that helps explore Milwaukee's rich array of beers! </font>
...
This is a teaser example to [lure you to see my dashboard]('https://jjohn9000.shinyapps.io/Milwaukee_Beer_App/').  
